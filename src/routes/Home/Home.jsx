            ...
            <div className={styles["hero-content"]}>
              ...
              {upcomingWorkshop?.date && (
                ...
                >
                  <Typography
                    variant="body"
                    className={styles["hero-date-text"]}
                  >
                    {upcomingWorkshop.date}
                  </Typography>
                </motion.div>
                  ...
                  {eventData.slice(0, 3).map((event, index) => (
                    <motion.div
                      ...
                      className={`${styles["event-detail-item"]} ${
                        index % 2 === 0
                          ? styles["event-detail-left"]
                          : styles["event-detail-right"]
                      }`}
                      variants={revealUpSoft}
                      initial="hidden"
                      whileInView="visible"
                        ...
                        <>
                          <div className={styles["event-detail-image"]}>
                            {event.coverPic ? (
                              ...
                              <div
                                className={styles["event-detail-placeholder"]}
                              ></div>
                            )}
                          </div>
                          <div className={styles["event-detail-text"]}>
                            ...
                            <Typography
                              variant="smallHeading"
                              className={styles["event-detail-title"]}
                            >
                              {event.name}
                            </Typography>
                            {event.date && (
                              <Typography
                                variant="body"
                                className={styles["event-detail-date"]}
                              >
                                {event.date}
                              </Typography>
                            )}
                            {event.location && (
                              <Typography
                                variant="body"
                                className={styles["event-detail-location"]}
                              >
                        ...
                        >
                          ...
                          >
                            {event.coverPic ? (
                              ...
                              <div
                                className={styles["gallery-placeholder"]}
                              ></div>
                            )}
                            <div className={styles["gallery-overlay"]}>
                              ...
                              {event.date && (
                                <Typography
                                  variant="subtitle"
                                  className={styles["gallery-item-date"]}
                                >
                                  {event.date}
                                </Typography>
                              )}
                ...
                <div className={styles["ambassador-card"]}>
                  <div className={styles["ambassador-content"]}>
                    <div className={styles["ambassador-text"]}>
                      <span className={styles["ambassador-badge"]}>
                        Join Us
                      </span>
                      <Typography
                        variant="body"
                        className={styles["ambassador-heading"]}
                      >
                        The Ambassador Track
                      </Typography>
                      <Typography
                        variant="body"
                        className={styles["ambassador-description"]}
                      >
                      ...
                      <Typography
                        ...
                        className={styles["ambassador-description"]}
                      >
                        Students also ensure that Garage will be an efficient
