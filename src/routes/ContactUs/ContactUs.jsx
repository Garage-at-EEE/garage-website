        ...
        <main className={styles["layout-container"]}>
          <div className={styles["layout-content"]}>
            <div className={styles["breadcrumbs"]}>
              ...
              <span
                className={`material-icons ${styles["breadcrumb-separator"]}`}
              >
                chevron_right
              </span>
              ...
              <section className={styles["main-column"]}>
                <div className={styles["title-block"]}>
                  ...
                  <p className={styles["page-subtitle"]}>
                    Have some curious questions, inquiries or feedback about
                    Garage@EEE? Contact us here or through our email.
                  </p>
                </div>
                ...
                <form className={styles["form"]} onSubmit={handleSubmit}>
                  <div className={styles["form-fields"]}>
                    ...
                    <div className={styles["input-box"]}>
                      ...
                      >
                        ...
                        <option value="Tinkering-project">
                          Tinkering Project
                        </option>
                    ...
                    <div className={styles["upload-file-container"]}>
                      <div className={styles["upload-title"]}>
                        ...
                        <span className={styles["upload-subtitle"]}>
                  ...
                  <p className={styles["privacy-text"]}>
                    By submitting the form, you consent to the terms stated in
                    this Personal Data Privacy Statement
                  </p>
                </form>
              </section>
                ...
                <div className={styles["info-card"]}>
                  ...
                  <div className={styles["info-items"]}>
                    <div className={styles["info-item"]}>
                      <div
                        className={`${styles["info-icon"]} ${styles["icon-blue"]}`}
                      >
                    ...
                    <div className={styles["info-item"]}>
                      <div
                        className={`${styles["info-icon"]} ${styles["icon-pink"]}`}
                      >
                      ...
                      <div className={styles["info-content"]}>
                        ...
                        <a
                          href="mailto:ntugarageeee@gmail.com"
                    ...
                    <div className={styles["info-item"]}>
                      <div
                        className={`${styles["info-icon"]} ${styles["icon-green"]}`}
                      >
